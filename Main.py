...
def write_rom(game: Game, romWriter: Optional[RomWriter] = None) -> str:
    ...
    rom_clean_path = "roms/Golden Dawn.sfc"
    ...
    # MB music patch thanks to neen
    romWriter.writeBytes(0x7dd72, b"\x1e\x05")
    romWriter.writeBytes(0x7dd8c, b"\x1e\x05")
    romWriter.writeBytes(0x7dda6, b"\x1e\x05")
